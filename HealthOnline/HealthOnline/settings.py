"""
Django settings for HealthOnline project.
...
SECRET_KEY = '=ns^at3y+zb#0(sbkf*0h0qzqtmk4^puv3to1fnrly(yqc3g!+'
...
ROOT_URLCONF = 'HealthOnline.urls'
...
WSGI_APPLICATION = 'HealthOnline.wsgi.application'
